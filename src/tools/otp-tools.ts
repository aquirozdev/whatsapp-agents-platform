...
import type { SecretRef, ToolContext, ToolExecutionResult } from "../core/types.js";
...
import type { OtpDeliveryProvider } from "../ports/otp-delivery.js";
...
export class OtpService {
  constructor(
    ...
    private readonly hmacSecretRef: SecretRef,
  ) {}
  ...
  async request(ctx: ToolContext, input: Record<string, unknown>): Promise<ToolExecutionResult> {
    ...
    await this.delivery.send({ channel, destination, code, ttlSeconds: ttl });
